  ...
  <div class="goods-detail">
    ...
    <div style="margin-top: 20px;font-family: Roboto;">
      <Tag v-for="tag in this.modelInfo.cateGory2.split(',')"
           :key="tag" class="goods-detail-tag">{{ tag }}
      </Tag>
    </div>
    <div style="margin-top: 20px">
      <Button style="margin-right: 10px; width: 100px;"
    ...
    <div style="margin-top: 20px">
      <Row :gutter="16">
        ...
        <Col span="12">
          <div class="goods-detail-right-top">
            <Button>下载</Button>
            <Button style="margin-left: 10px" @click="goRun">运行</Button>
          </div>
